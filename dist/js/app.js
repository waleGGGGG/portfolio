(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            } else if (document.documentElement.classList.contains("menu-open") && !e.target.closest(".menu") && !e.target.closest(".icon-menu")) functions_menuClose();
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const languageButton = document.querySelector(".language__btn");
        const languageMenu = document.querySelector(".language__menu");
        const languageLinks = document.querySelectorAll(".language__menu a");
        let selectedLang = "UA";
        updateLanguageMenu(selectedLang);
        ...
        document.addEventListener("click", (function(event) {
            if (!languageMenu.contains(event.target) && !languageButton.contains(event.target)) languageMenu.classList.remove("visible");
        }));
        ...
        function changeLanguage(lang) {
            ...
            const code = document.querySelector(".language__code");
            switch (lang) {
              case "UA":
                icon.src = "img/header/ang-icon.svg";
                code.textContent = "UA";
                break;
        ...
        function updateLanguageMenu(selectedLang) {
            languageLinks.forEach((link => {
                if (link.getAttribute("data-lang") === selectedLang) languageMenu.prepend(link);
            }));
        }
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        window.addEventListener("scroll", (function() {
            ...
            if (scrollPosition > 250) scrollToTopBtn.classList.add("show"); else scrollToTopBtn.classList.remove("show");
        }));
